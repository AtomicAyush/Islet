...
/// inside it and everything else is clear. Clicks fall through to whatever is below
/// except while the pointer is over the island itself — `IslandWindowController`
/// flips `ignoresMouseEvents` as the pointer moves.
